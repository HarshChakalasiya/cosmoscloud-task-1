...
def merge_lists(list_1, list_2) -> list:
    ...
    """
    list_1_dict = {student["id"]: student for student in list_1}
    list_3 = {
        student["id"]: (list_1_dict[student["id"]] | student) if (student["id"] in list_1_dict.keys()) else student for
        student in list_1 + list_2}.values()
    list_3 = list(list_3)
    return list_3
